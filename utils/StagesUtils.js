const { insertUser, checkInsertedUser, updateUserStatus, getUserStatus, updateUserLastMessage } = require('../utils/DatabaseUtils.js')
    ...
    try{
        ...
        if(!checkUser){
            ...
            if(userStage == null){
                ...
                const { result } = require(`../stages/stage${userStage}.js`);
